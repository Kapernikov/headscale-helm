...
![Version: 0.3.0](https://img.shields.io/badge/Version-0.3.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.29.3](https://img.shields.io/badge/AppVersion-0.29.3-informational?style=flat-square)
...
Chart 0.3.0 ships headscale `v0.29.3` (previous chart releases shipped `v0.28.0`).

**Headscale now enforces a strict upgrade path**: skipping a minor version is
refused, and so is downgrading. Coming from a chart release older than 0.2.0
